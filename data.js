const MODULE_DEFS = {
  ...
  halftone: {
    ...
    params: [
      { id: 'mode',        label: 'Mode',       type: 'mode-chip',      options: ['bw','duotone','cmyk'],               default: 'cmyk' },
      { id: 'cellSize',    label: 'Screen',      type: 'screen-chip',    min: 3, max: 24, step: 1,                       default: 10 },
      { id: 'dotShape',    label: 'Dot Shape',   type: 'dotshape-chip',  options: ['circle','diamond','line'],            default: 'circle' },
      { id: 'paperColor',  label: 'Paper',       type: 'paper-chip',                                                     default: '#f0ead8' },
      { id: 'duotoneColor1', label: 'Color 1', type: 'duotone-color-chip', angleId: 'angleK', default: '#1a1008' },
      { id: 'duotoneColor2', label: 'Color 2', type: 'duotone-color-chip', angleId: 'angleC', default: '#d4890a' },
      { id: 'masterAngle', label: 'MASTER',      type: 'angle-chip',     master: true, min: 0, max: 179, step: 1,        default: 0  },
      { id: 'angleK',      label: 'K',           type: 'angle-chip',                   min: 0, max: 179, step: 1,        default: 45 },
      { id: 'angleC',      label: 'C',           type: 'angle-chip',                   min: 0, max: 179, step: 1,        default: 15 },
      { id: 'angleM',      label: 'M',           type: 'angle-chip',                   min: 0, max: 179, step: 1,        default: 75 },
      { id: 'angleY',      label: 'Y',           type: 'angle-chip',                   min: 0, max: 179, step: 1,        default: 90 },
    ]
  },
  press: {
